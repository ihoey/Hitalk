...
var Hitalk = function Hitalk(option) {
  ...
  var serverURLs = option.serverURLs || 'https://hitalk.dode.top';
  ...
  var addSmilies = function () {
    ...
    Object.keys(smiliesData).forEach(function (y, i) {
      ...
      smiliesData[y].split('|').forEach(function (e) {
        _ul.innerHTML += "<li class=\"smilies-item\" title=\"" + e + "\" data-input=\"" + ((y == sl ? '@' : '#') + "(" + e + ")") + "\"><img class=\"biaoqing " + (y == sl ? 'newpaopao' : 'alu') + "\" title=\"" + e + "\" src=\"https://cdn.dode.top/" + (y == sl ? 'newpaopao' : 'alu') + "/" + (e + subfix) + ".png\"></li>";
      });
